...
namespace CloudDeliveryMobile.Android.Fragments.Salepoint.SideView
{
    ...
    public class SalepointSideAddedOrdersFragment : MvxFragment<SalepointSideAddedOrdersViewModel>
    {
        ...
        private int FragmentId { get; } = Resource.Layout.salepoint_side_added_orders;
    }
}