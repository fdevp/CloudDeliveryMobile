...
{
    [MvxFragmentPresentation(fragmentContentId: Resource.Id.carrier_side_view_layout, IsCacheableFragment = true)]
    public class CarrierSideViewFragment : MvxFragment<CarrierSideViewViewModel>, IOnGlobalLayoutListener
    {
        ...
        public void OnGlobalLayout()
        {
            ...
            var containerElement = this.view.FindViewById<RelativeLayout>(Resource.Id.carrier_side_view_container);

            var sideViewTouchElement = view.FindViewById<RelativeLayout>(Resource.Id.carrier_side_view_touch);

            var contentElement = view.FindViewById<RelativeLayout>(Resource.Id.carrier_side_view_content);
